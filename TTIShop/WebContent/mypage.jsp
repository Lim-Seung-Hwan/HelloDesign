...
">		
        <div class="container">
            <div class="row mp_list">
                <div class="col-lg-4 mp_button" onclick="location.href='buy.jsp'">
                	<img src="img/order.png" class="mp_img"/>
                	<div>
	                    <h4>구매 내역 확인</h4>
	                    <span>지금까지의 구매 내역을 확인합니다.</span>
                	</div>
                </div>
                <div class="col-lg-4 mp_button" onclick="location.href='update.jsp'">
                	<img src="img/profile.png" class="mp_img"/>
                	<div>
	                    <h4>회원 정보 수정</h4>
	                    <span>회원 정보를 확인하고 수정합니다.</span>
                	</div>
                </div>
