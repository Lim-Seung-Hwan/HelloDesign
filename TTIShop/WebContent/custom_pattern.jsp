            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9" style="float:left;">
				   ...
				   %> --%>
				   	...
				   	<%try{
				   		Thread.sleep(3000);%>
				   		<img src="./img/pattern/example.png" style="width: 512px; height: 512px;" >
				   	...
				   	<form action="http://localhost:9000" method="post">
						<input type="submit" value="이미지 재생성">
				    </form>
				   ...
				   <div id="image_preview">
					...
					<div class="f_box">
					<label for="img">사진첨부</label> <input type="file" id="img"name="bf_file[]">
					</div>
